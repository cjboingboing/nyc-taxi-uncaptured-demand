...
Calum Moir \\
Student ID: 1352920 \\
\href{https://github.com/cjboingboing/nyc-taxi-uncaptured-demand/tree/a5f286c718f78637d960042ef5e2bf31a4ed678a}{Github repo with commit}
}
...
\begin{itemize}
    \item[$\star$] TLC reports no taxi ID, so \texttt{effective\_taxis} -- a Little's-Law fleet-occupancy estimate, developed in Section~\ref{sec:results} -- would be circular as a model \emph{feature}: it is computed from the same cell's own trip count, the quantity being predicted.
...
\begin{itemize}
\item \textbf{Every dollar figure is a hypothetical ceiling, not a promised return.} \$827{,}773/hr
...
(\$82{,}772/\$165{,}543/\$248{,}315/hr at $10/20/30\%$) rather than a single number, and
